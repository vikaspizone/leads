...
import 'package:leads/ui/views/incoming_call/incoming_call_view.dart' as _i4;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i4.IncomingCallView: (data) {
      return _i5.MaterialPageRoute<dynamic>(
        builder: (context) => const _i4.IncomingCallView(),
        settings: data,
      );
    },
  };
