...
//common card
Container renderCard({Widget? child, String? buttonTitle, String? leadsName}) {
  return Container(
      decoration: BoxDecoration(
              ...
              children: [
                ...
                renderCard(
                    ...
                    child: FlipCard(
                        ...
                        back:
                            BackSide(gridDetail: HomeViewModel().gridDetail))),
                spacer,
                //Users card
                renderCard(
                    buttonTitle: viewAll,
                                ...
                                children: [
                                  ...
                                  Positioned(
                                      ...
                                      child: renderContainerWithImage(
                                          screenDimension(context),
                                          child: Image.asset(Images().boy1))),
                                  Positioned(
                                      left: 40,
                                      child: renderContainerWithImage(
                                          screenDimension(context),
                                          child: Image.asset(Images().boy2))),
                                  Positioned(
                                      left: 60,
                                      child: renderContainerWithImage(
                                          screenDimension(context),
                                          child: Image.asset(Images().boy3))),
                                  Positioned(
                                      left: 80,
                                      child: renderContainerWithImage(
                                          screenDimension(context),
                                          child: Image.asset(Images().girl2))),
                                  Positioned(
                                      left: 100,
                                      child: renderContainerWithImage(
                                          screenDimension(context),
